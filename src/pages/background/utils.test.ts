...
describe('renderBlock', () => {
  ...
  test('should suit all date format in logseq', () => {
    const dateFormatMap: Map<string, string> = new Map([
      ...
      ['E, dd-MM-yyyy', 'Fri, 19-08-2021'],
      ['E, dd.MM.yyyy', 'Fri, 19.08.2021'],
      ['E, MM/dd/yyyy', 'Fri, 08/19/2021'],
      ['E, yyyy/MM/dd', 'Fri, 2021/08/19'],
      ['EEE, dd-MM-yyyy', 'Fri, 19-08-2021'],
      ['EEE, dd.MM.yyyy', 'Fri, 19.08.2021'],
      ['EEE, MM/dd/yyyy', 'Fri, 08/19/2021'],
      ['EEE, yyyy/MM/dd', 'Fri, 2021/08/19'],
      ['EEEE, dd-MM-yyyy', 'Friday, 19-08-2021'],
      ['EEEE, dd.MM.yyyy', 'Friday, 19.08.2021'],
      ['EEEE, MM/dd/yyyy', 'Friday, 08/19/2021'],
      ['EEEE, yyyy/MM/dd', 'Friday, 2021/08/19'],
      ...
      ['yyyy-MM-dd', '2021-08-19'],
      ['yyyy-MM-dd EEEE', '2021-08-19 Friday'],
