...
export class Google implements SearchingEngine {
...
export class Bing implements SearchingEngine {
  isMatch(): boolean {
...
export class DuckDuckGo implements SearchingEngine {
  isMatch(): boolean {
...
export class Yandex implements SearchingEngine {
  isMatch(): boolean {
...
export class SearX implements SearchingEngine {
  isMatch(): boolean {
...
export class Baidu implements SearchingEngine {
  isMatch(): boolean {
    // Check if the website is using the searx engine
